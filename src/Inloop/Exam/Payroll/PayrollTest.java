...
public class PayrollTest {
    ...
    public void testConstructorDisposition() {
        try {
            new Payroll(null, 1);
            fail("inloop.exam.Payroll.inloop.exam.Payroll() should throw a NullPointerException if the disposition argument is null!");
    ...
    public void testConstructorInvalidPayday() {
        try {
            ...
            fail("inloop.exam.Payroll.inloop.exam.Payroll() should throw an IllegalArgumentException if the payday argument is invalid!");
    ...
    public void testConstructorValidPayday() {
        try {
            ...
            fail("inloop.exam.Payroll.inloop.exam.Payroll() should not throw an IllegalArgumentException if the payday argument is valid!");
        }
    }
    ...
    public void testDoPayrollNullArgument() {
        try {
            ...
            fail("inloop.exam.Payroll.doPayroll() should throw a NullPointerException if the argument is null!");
        } catch (NullPointerException e) {
        }
    }
    ...
    public void testDoPayroll() {
        ...
        assertEquals("inloop.exam.Payroll.doPayroll() should send a payment for every Employee to be paid!", 1599, payments.get(e1), 0.001);
        assertEquals("inloop.exam.Payroll.doPayroll() should send a payment for every Employee to be paid!", 1075.8, payments.get(e4), 0.001);
        assertEquals("inloop.exam.Payroll.doPayroll() should send a payment for every Employee to be paid!", 1200, payments.get(e7), 0.001);
        assertEquals("inloop.exam.Payroll.doPayroll() should only send payments for Employees to be paid!", 3, payments.size());
    }
}
