...
public class LeetTest {
    ...
    public void testMethodsAreStatic() {
        ...
        try {
            ...
            fail("The class Leet should have a method named toLeet with one parameter of type String!");
        }
        ...
        try {
            ...
            fail("The class Leet should have a method named allToLeet with one parameter of type String[]!");
        }
